...
"""
Module 4-wgan_gp
Extends the WGAN_GP class with a method to replace
generator and discriminator weights from .h5 files.
"""
...
class WGAN_GP(keras.Model):
    """
    Wasserstein GAN model class with gradient penalt
    and weight replacement functionality.
    ...
    def replace_weight(self, gen_h5, disc_h5):
        """
        Replaces the weights of the generator and discriminator models
        with weights stored in the specified .h5 files.
        """
